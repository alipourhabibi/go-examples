...
type StreamingRateRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Message:
	//	*StreamingRateRequest_RateRequest
	//	*StreamingRateRequest_Error
	Message isStreamingRateRequest_Message `protobuf_oneof:"message"`
}

func (x *StreamingRateRequest) Reset() {
	*x = StreamingRateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StreamingRateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamingRateRequest) ProtoMessage() {}

func (x *StreamingRateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_currency_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamingRateRequest.ProtoReflect.Descriptor instead.
func (*StreamingRateRequest) Descriptor() ([]byte, []int) {
	return file_currency_proto_rawDescGZIP(), []int{2}
}

func (m *StreamingRateRequest) GetMessage() isStreamingRateRequest_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *StreamingRateRequest) GetRateRequest() *RateRequest {
	if x, ok := x.GetMessage().(*StreamingRateRequest_RateRequest); ok {
		return x.RateRequest
	}
	return nil
}

func (x *StreamingRateRequest) GetError() *status.Status {
	if x, ok := x.GetMessage().(*StreamingRateRequest_Error); ok {
		return x.Error
	}
	return nil
}

type isStreamingRateRequest_Message interface {
	isStreamingRateRequest_Message()
}

type StreamingRateRequest_RateRequest struct {
	RateRequest *RateRequest `protobuf:"bytes,1,opt,name=rate_request,json=rateRequest,proto3,oneof"`
}

type StreamingRateRequest_Error struct {
	Error *status.Status `protobuf:"bytes,2,opt,name=error,proto3,oneof"`
}

func (*StreamingRateRequest_RateRequest) isStreamingRateRequest_Message() {}

func (*StreamingRateRequest_Error) isStreamingRateRequest_Message() {}
...
var file_currency_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x52, 0x61, 0x74, 0x65, 0x22, 0x80, 0x01, 0x0a,
	0x14, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x61, 0x74, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x31, 0x0a, 0x0c, 0x72, 0x61, 0x74, 0x65, 0x5f, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x52, 0x61,
	0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x72, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f,
	...
	,
...
var file_currency_proto_goTypes = []interface{}{
	...
	(*StreamingRateRequest)(nil), // 3: StreamingRateRequest
...
var file_currency_proto_depIdxs = []int32{
	...
	1, // 4: StreamingRateRequest.rate_request:type_name -> RateRequest
	4, // 5: StreamingRateRequest.error:type_name -> google.rpc.Status
	1, // 6: Currency.GetRate:input_type -> RateRequest
	1, // 7: Currency.Subscribe:input_type -> RateRequest
	2, // 8: Currency.GetRate:output_type -> RateResponse
	3, // 9: Currency.Subscribe:output_type -> StreamingRateRequest
...
func file_currency_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_currency_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamingRateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_currency_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*StreamingRateRequest_RateRequest)(nil),
		(*StreamingRateRequest_Error)(nil),
	}
	type x struct{}
